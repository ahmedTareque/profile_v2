...
const About = () => {
  ...
  const skills = ['Java', 'Spring Boot', 'JavaScript (ES6+)', 'TypeScript', 'Angular'];
      ...
      <div className="inner">
        <StyledText>
          ...
          <div>
            ...
            <p>
              <b>
                Now a days, I am challenging myself to be disciplined as in maintaining a proper diet, going to gym, learning chess, reading books, keeping daily notes in Notion. And to be honest, it is really difficult in terms of ditching all sorts of distractions and staying focused. Though I am failing often, I am growing and I am pretty confident I am gonna do that.
              </b>
            </p>
          </div>
